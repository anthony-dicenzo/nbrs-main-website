export const meta = {
	slug: 'multiplex-zoning-review',
	title: "Toronto's Multiplex Zoning Review: 1,000 Projects, 115 Years of Delays",
	date: '2026-02-20',
	description: 'Toronto is approaching 1,000 multiplex project applications since the 2023 zoning changes. But permit delays are adding up to over a century of lost time.'
};
...
<h2>What This Means for Multiplex Housing in Toronto</h2>

<p>Every month a multiplex project sits in permit review is a month families don't have homes. It's a month of carrying costs that make projects less viable. And it's a signal to builders that "as-of-right" doesn't actually mean what it says.</p>

<p>At NBRS, we've built our entire approach around navigating these realities. We target sites where we can move fast, we prepare permit-ready drawings before acquisition, and we use technology to streamline what the system doesn't.</p>

<p>But individual workarounds aren't enough. Toronto needs to resource its permit system to match the ambition of its zoning policy. The city opened the door to multiplex housing — now it needs to clear the path.</p>

<p><a href="/family-1">FAMILY 1</a>, our first multiplex project, is proof that it can be done in 12-18 months. But it shouldn't require this much effort to build the housing a city says it wants.</p>

<p><a href="/waitlist">Join our waitlist</a> to follow our progress, or <a href="/partner">partner with us</a> to build more.</p>
`;
