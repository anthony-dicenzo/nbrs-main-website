...
<!-- Hero Section -->
<section aria-label="FAMILY 1 Waitlist" class="relative py-16 sm:py-24 md:py-32 bg-gray-900 text-white overflow-hidden">
	<div class="absolute inset-0 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900" aria-hidden="true"></div>
	<div class="absolute inset-0 opacity-20" aria-hidden="true">
		<div class="absolute top-1/4 right-1/4 w-64 sm:w-96 h-64 sm:h-96 bg-nbrs-green rounded-full blur-3xl"></div>
		<div class="absolute bottom-1/4 left-1/4 w-48 sm:w-64 h-48 sm:h-64 bg-nbrs-green rounded-full blur-3xl"></div>
	</div>
...
<!-- Features Section -->
<section aria-label="Unit features" class="py-12 sm:py-16 md:py-20 bg-white border-b border-gray-100">
		...
		<div class="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
			{#each features as feature, i}
				...
				>
					...
					<h3 class="font-bold text-gray-900 mb-1 text-sm sm:text-base">{feature.title}</h3>
					<p class="text-xs sm:text-sm text-gray-600">{feature.description}</p>
				</div>
			{/each}
		</div>
	</div>
...
<section aria-labelledby="waitlist-heading" class="py-16 sm:py-20 md:py-28 bg-gray-50">
	<div class="max-w-6xl mx-auto px-4 sm:px-6">
		<div class="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-start">
			<div use:scrollReveal={{ type: 'slide-up', duration: 0.8 }}>
				...
				<h2 id="waitlist-heading" class="text-2xl xs:text-3xl sm:text-4xl font-bold text-gray-900 mb-4 sm:mb-6">
					Be First to Know
				</h2>
				...
				<div class="bg-white rounded-xl p-4 sm:p-6 border border-gray-200">
					<h3 class="font-bold text-gray-900 mb-3 sm:mb-4 text-sm sm:text-base">What to Expect</h3>
					<ul class="space-y-2 sm:space-y-3">
						<li class="flex items-start gap-2 sm:gap-3">
							<svg class="w-4 sm:w-5 h-4 sm:h-5 text-nbrs-green flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
								<path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
							</svg>
							<span class="text-gray-600 text-sm sm:text-base">Early notification when units become available</span>
						</li>
						<li class="flex items-start gap-2 sm:gap-3">
							<svg class="w-4 sm:w-5 h-4 sm:h-5 text-nbrs-green flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
								<path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
							</svg>
							<span class="text-gray-600 text-sm sm:text-base">Exclusive preview of floor plans and pricing</span>
						</li>
						<li class="flex items-start gap-2 sm:gap-3">
							<svg class="w-4 sm:w-5 h-4 sm:h-5 text-nbrs-green flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
								<path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
							</svg>
							<span class="text-gray-600 text-sm sm:text-base">Priority application window before public release</span>
						</li>
						<li class="flex items-start gap-2 sm:gap-3">
							<svg class="w-4 sm:w-5 h-4 sm:h-5 text-nbrs-green flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
								<path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
							</svg>
							<span class="text-gray-600 text-sm sm:text-base">Updates on construction progress and timeline</span>
						</li>
					</ul>
				</div>
			</div>
			...
			<div class="bg-white rounded-2xl p-5 sm:p-8 shadow-lg" use:scrollReveal={{ type: 'fade', duration: 1, delay: 0.2 }}>
				{#if submitStatus === 'success'}
					<div class="text-center py-6 sm:py-8" role="status" aria-live="polite">
						<div class="w-14 sm:w-16 h-14 sm:h-16 mx-auto mb-4 rounded-full bg-nbrs-green/10 flex items-center justify-center" aria-hidden="true">
				...
				{:else}
					<h3 class="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">Join the Waitlist</h3>
...
<!-- Learn More CTA -->
<section aria-labelledby="learn-more-heading" class="py-12 sm:py-16 md:py-24 bg-white">
	<div class="max-w-4xl mx-auto px-4 sm:px-6 text-center" use:scrollReveal={{ type: 'fade', duration: 0.8 }}>
		<h2 id="learn-more-heading" class="text-xl xs:text-2xl sm:text-3xl font-bold text-gray-900 mb-3 sm:mb-4">
			Want to Learn More?
		</h2>
		...
		<a
			href="/family-1"
			class="btn btn-primary group inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold min-h-[48px]"
		>
